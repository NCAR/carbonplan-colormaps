const colormaps = [
  ...
  { name: 'browngreen', type: 'sequentialMultiHue' },
  { name: 'blueprecip', type: 'sequentialMultiHue' },
  // { name: 'BrBG', type: 'sequentialMultiHue' },
  { name: 'seismic', type: 'diverging' },
  { name: 'BrBG', type: 'diverging' },
